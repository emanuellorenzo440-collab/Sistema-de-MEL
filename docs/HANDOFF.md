...
- Cuando la API esta disponible, la interfaz arranca con los reportes remotos, empuja nuevos reportes, importaciones y revisiones al backend y pinta la lectura analitica desde el overview remoto.
