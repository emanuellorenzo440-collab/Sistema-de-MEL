...
import { applyOrganizationBranding, brandingFromUser, loadPublicOrganizationBranding } from "./services/organization-branding.js?v=20260609a";
...
async function loadMonitoringApp(authenticatedUser = null) {
  ...
  monitoringAppPromise = (async () => {
    const [{ createMonitoringApp }, { bootstrapApiBridge, startRuntimeBridge }] = await Promise.all([
      import("./features/monitoring-app.js?v=20260609a"),
      import("./services/mel-runtime-bridge.js?v=20260609a"),
    ]);
