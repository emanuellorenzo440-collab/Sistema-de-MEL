import { initializeAccessLobby } from "./features/access-lobby.js?v=20260521a";
...
async function loadMonitoringApp(authenticatedUser = null) {
  ...
  monitoringAppPromise = (async () => {
    const [{ createMonitoringApp }, { bootstrapApiBridge, startRuntimeBridge }] = await Promise.all([
      import("./features/monitoring-app.js?v=20260521a"),
      import("./services/mel-runtime-bridge.js?v=20260521a"),
    ]);
